...
species_data_headings = ['Scientific Name', 'Common Name', 'Appendix', 'Source','Quantity', 'Description', 'Country of Origin', 
...
def analyze_with_model(file_path):
    # To be converted to an .env file 
    endpoint = ""
    key = ""
...
def organize_data():
    ...
    for x in range(length):
        output_data.append([species_list[scienceName[x]], species_list[commonName[x]], species_list[appendix[x]], species_list[source[x]], species_list[desc[x]],
